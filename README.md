...
[![References](https://img.shields.io/badge/references-13-F2EBDD?style=flat-square&labelColor=0B0C0D)](references)
...
TalkDirector 会在执行前确认准确时间段，自动按官方来源顺序获取 Logo，并根据真实手势分别安排触发时刻。完整导演规则、动画参数和验证帧要求见 [Prompt 001](references/prompt-001-gesture-logo-pop.md)。
...
仓库包含 1 个根 Skill、13 份聚焦参考文档、中英文完整示例，以及 9 个行为场景。
